...
<div class="container" id="container">
	...
	<div class="form-container sign-in-container">
		<form action="home.php" method="POST">
			<h1 id="idH1">Sign in with OTP</h1>
			
			<div class="social-container">
				

			</div>
			<input type="number" required name="number" onInput="this.value = this.value.slice(0, 11)" placeholder="Number"/>
			
			
			
			<button name="sentOTP"  class="btn btn-warning">SEND OTP</button>
